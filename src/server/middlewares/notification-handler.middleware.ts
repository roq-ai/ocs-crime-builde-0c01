...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'crime.create': {
    roles: ['team-member'],
    key: 'new-crime-created',
    tenantPath: ['organization', 'crime'],
    userPath: [],
  },
  'crime.update': { roles: ['team-member'], key: 'crime-updated', tenantPath: ['organization', 'crime'], userPath: [] },
  'player_knowledge.create': {
    roles: ['team-member'],
    key: 'knowledge-assigned',
    tenantPath: ['organization', 'crime', 'player', 'player_knowledge'],
    userPath: [],
  },
};
