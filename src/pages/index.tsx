...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`OCS Crime Builder`}</title>

        <meta
          name="description"
          content="Unleash your creativity with OCS Crime Builder, a dynamic platform for crafting intriguing team-building events. Create unique crime scenarios, assign roles, and generate compelling narratives, fostering collaboration and problem-solving among players. Dive into the mystery today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605806616949-1e87b487fc2f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcmltZXxlbnwwfHx8fDE2OTM0MDIwNTF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your creativity with OCS Crime Builder, a dynamic platform for crafting intriguing team-building events. Create unique crime scenarios, assign roles, and generate compelling narratives, fostering collaboration and problem-solving among players. Dive into the mystery today!`}
            </Text>
            <Box
