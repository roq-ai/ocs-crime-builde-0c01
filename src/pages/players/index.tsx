...
export function PlayerListPage(props: PlayerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPlayers({
        relations: ['user', 'crime', 'player_knowledge.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'personality_trait.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'personality_trait', header: 'Personality Trait', accessorKey: 'personality_trait' },
