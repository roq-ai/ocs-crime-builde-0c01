...
import { getCrimeById } from 'apiSdk/crimes';
import { CrimeInterface } from 'interfaces/crime';
import { KnowledgeListPage } from 'pages/knowledges';
import { PlayerListPage } from 'pages/players';

function CrimeViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('crime', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/crimes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Num Players" text={data?.num_players} />

                <FormListItem label="Num Killers" text={data?.num_killers} />

                <FormListItem label="Victim Name" text={data?.victim_name} />
